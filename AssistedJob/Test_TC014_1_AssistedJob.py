...
class Test_TC014_1_AssistedJob:
    ...
    def test_TC014_1_AssistedJob(self, test_setup, mainPDF, backPDF, JobName, EmailPhone, ToAddress, AddType, ImagePath,
        ...
        try:
            if "Buy Credit" in self.msg:
                ...
                self.logger.info("Test_TC014_1_AssistedJob.py is Passed")
                time.sleep(2)
                self.lo.Logout()
            else:
                allure.attach(self.driver.get_screenshot_as_png(),
                ...
                self.logger.info("Test_TC014_1_AssistedJob.py is Failed")
                time.sleep(2)
                assert False
