...
class Test_TC007_2_Jobs_PDF_OneBusinessDayProcessing:
    ...
    def test_TC007_2_Jobs_PDF_OneBusinessDayProcessing(self, test_setup, name, ForwardEmail, UpdateAddress,text, Name1, Company, Add1,
        ...
        try:
            if "Buy Credit" in self.msg:
                ...
                self.logger.info("Test_TC007_2_Jobs_PDF_OneBusinessDayProcessing Is Passed")
                time.sleep(5)
                ...
                self.logger.info("Test_TC007_2_Jobs_PDF_OneBusinessDayProcessing Is Failed")
                time.sleep(2)
                assert False
